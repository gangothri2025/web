...
function loadProperties() {
    const properties = [
        ...
        },
        {
            ...
            baths: 4,
            area: '5,000 sq ft',
            image: 'https://images.unsplash.com/photo-1494891848038-7bd202a2afeb?q=80&w=800',
            badge: 'Heritage',
            ...
            <div class="property-card">
                <div class="property-image">
                    ...
                    <div class="property-actions">
                        ...
                        <button class="property-action" title="Quick view">
                            <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    ...
                    <div class="property-features">
                        ...
                        <div class="property-feature">
                            <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                ...
                                <path d="M9 18l-2.5 2.5a1.5 1.5 0 0 1-1 0l-1-1a1.5 1.5 0 0 1 0-1L6.5 15 9 18Z"></path>
                        ...
                        <div class="property-feature">
                            ...
                            ${property.area}
                                      ...
                                      <button class="btn-primary property-button" onclick="downloadBrochure('${property.pdf}', '${property.title} Brochure')">
    <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="width: 16px; height: 16px; margin-right: 8px;">
